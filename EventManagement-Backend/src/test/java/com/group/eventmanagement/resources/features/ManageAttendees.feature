Feature: Manage attendees
  As an organizer of an event,
  I want to be able to remove attendees from an event, so I can avoid certain users.
  ...
  Scenario: Remove an attendee successfully
    ...
    Then "user1234" is removed from the list of attendees of the event with ID "2234"
    	| eventId | eventDate  | isPrivate | isVirtual | location                  | description | image         | organizers | attendees |
